...
has = getgenv().has
need = getgenv().need
queue_on_teleport(getgenv().need = need getgenv().has = (has+1)"loadstring(game:HttpGet(\"https://raw.githubusercontent.com/ilikecheesemuchwow/eee/refs/heads/main/duper.lua",true))()")
if (has <= need) then
